            ...
            <div className="flex flex-col p-3 gap-0.5">
              ...
              {/* {activities.fakeActivities().map((faker, fakerKey) => (
                <a
                  href=""
                  key={fakerKey}
                  className="flex items-center px-3 py-2.5 rounded-xl hover:bg-slate-100/80 dark:hover:bg-darkmode-400"
                >
                  <div>
                  ...
                  <div className="sm:ml-5">
                    ...
                    {faker.images && (
                      <div className="w-40 sm:w-56 my-3.5 p-1 border rounded-[0.6rem] bg-slate-50/80 dark:bg-darkmode-400">
